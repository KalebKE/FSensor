 ...
 */
public class KalmanLinearAccelerationSensor extends LinearAccelerationSensor {
    private static final String TAG = KalmanLinearAccelerationSensor.class.getSimpleName();

    public KalmanLinearAccelerationSensor(SensorManager sensorManager) {
        super(sensorManager, new KalmanOrientation());
    }
}
