...
/**
 * Mahony AHRS filter with Android sensor integration.
 * <p>
 * A PI complementary filter on SO(3) that provides good orientation
 * estimation with low computational cost. The integral term compensates
 * for gyroscope bias drift.
 */
public class MahonyRotation implements Rotation, FusionAlgorithm {
    ...
    private final MahonyFusion fusion;
    ...
    public MahonyRotation(SensorManager sensorManager) {
        this(sensorManager, DEFAULT_KP, DEFAULT_KI);
    }

    public MahonyRotation(SensorManager sensorManager, float kp, float ki) {
        this.sensorManager = sensorManager;
        this.fusion = new MahonyFusion(kp, ki);
    }
