...
@Composable
fun OrientationTab(orientation: FloatArray, history: ChartData) {
    ...
    Column(
        ...
        Row(
            ...
            LabeledValue("H", heading, ChartRed)
            LabeledValue("P", pitch, ChartGreen)
            LabeledValue("R", roll, ChartBlue)
        }
